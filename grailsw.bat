...
if "x%GRAILS_AGENT_CACHE_DIR%" == "x" set GRAILS_AGENT_CACHE_DIR=%SHORTHOME%/.grails/2.2.2/
...
set AGENT_STRING=-javaagent:grailsWrapper/springloaded-core-1.1.1.jar -noverify -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=grailsWrapper/grails-wrapper-runtime-2.2.2.jar;grailsWrapper;.
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.2.2
